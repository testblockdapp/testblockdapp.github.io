...
contract CommunityStakingExperiement is Context, ERC20 {
    ...
    uint256 private _totalSupply =90000000000000;
...
contract GlobalsAndUtility is CommunityStakingExperiement {
    /*  XfLobbyEnter
    */
    event XfLobbyEnter(
        uint256 timestamp,
    ...
    */
    ...
    /* Flush address */
    address payable internal constant FLUSH_ADDR = 0xdcA9e37fd9C666891F098efc840e04DddfB5BBF9;
    uint8 internal LAST_FLUSHED_DAY = 1;

    /* ERC20 constants */
    string public constant name = "CSE";
    ...
    /* Time of contract launch (2020-11-2T00:00:00Z) */
    uint256 internal constant LAUNCH_TIME = 1604232000;
    ...
    uint256 private constant BPB_MAX_CSE = 7 * 1e6;
...
contract TransformableToken is StakeableToken {
    ...
    {
        /* 1095890410958 = ~ 4000000 * SUNS_PER_CSE / 365 */
