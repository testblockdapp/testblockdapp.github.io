...
<div class="border-b hd-nm border-theme-24 -mt-10 md:-mt-5 -mx-3 sm:-mx-8 px-3 sm:px-8 pt-3 md:pt-0 mb-10" style="background: #282b36;border-bottom: 1px solid #040417;">
    <div class="top-bar-boxed flex items-center">
        ...
        <a href="http://cseeth.com"><img src="./img/cse-icon-2.png" style="width: 4rem; margin-top: 0rem;"></a>
        ...
        <div style="background: #282b36;/* box-shadow: 2px 2px 8px #07d562; */height: 38px;border-radius: 6px;padding: 2px 0px 0px 10px;border: 3px solid #07d562;color: #a2a8a9;font-size: 18px;font-weight: 500;margin-right: 20px;"><span class="telegram" style="padding-right: 10px;"><a href="https://t.me" target="_blank">Telegram</a></span></div>

        <div style="background: #282b36;/* box-shadow: 2px 2px 8px #07d562; */height: 38px;border-radius: 6px;padding: 2px 0px 0px 10px;border: 3px solid #07d562;color: #a2a8a9;font-size: 18px;font-weight: 500;margin-right: 20px;"><span class="etherscan" style="padding-right: 10px;"><a href="https://etherscan.io/" target="_blank">Etherscan</a></span></div>

        <div style="background: #282b36;/* box-shadow: 2px 2px 8px #07d562; */height: 38px;border-radius: 6px;padding: 2px 0px 0px 10px;border: 3px solid #07d562;color: #a2a8a9;font-size: 18px;font-weight: 500;margin-right: 20px;"><span class="day-end-in" id="countdown" style="padding-right: 10px;">Auction ends at: 00:00:00</span></div>
